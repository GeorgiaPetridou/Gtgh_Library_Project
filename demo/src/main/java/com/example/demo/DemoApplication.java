...
//		ThemeServices thService = new ThemeServices();
//		AuthorServices aService = new AuthorServices();
//		BookServices bService = new BookServices();
//		PersonServices pService = new PersonServices();
...
//		System.out.println(thService.getAllThemes());
//		thService.removeTheme(th4);
//		thService.removeTheme(th3);
...
//		pService.borrowBook(1, b3);
//		pService.borrowBook(1, b2);
//		pService.borrowBook(2, b3);
//		pService.borrowBook(2, b1);
//		pService.borrowBook(3, b2);
//		System.out.println("____________________Users with Books____________________");
//		System.out.println(pService.getAllUsers());
//		pService.returnBook(3, b2.getId());
